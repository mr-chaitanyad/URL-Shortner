...
import { FiCopy, FiMousePointer, FiCalendar, FiLink } from "react-icons/fi";
                ...
                <div className="max-w-7xl mx-auto px-6 py-10">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-5">
                            <div className="bg-white rounded-2xl p-6 shadow-sm border">
                                <p className="text-slate-500">Total URLs</p>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border mt-8">
                        <div className="px-8 py-6 border-b flex justify-between">
                            ...
                            <span className="text-slate-500">{totalUrls} Links</span>
                        </div>
                                ...
                                <div className="space-y-5">
                                    {urls.map((item) => (
                                        ...
                                        >
                                            ...
                                            <div className="mt-5">
                                                ...
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <button
                                                        ...
                                                        className="flex items-center gap-2 bg-slate-200 px-3 py-1 rounded-lg text-sm hover:bg-slate-300"
                                                    >
                                                        <FiCopy size={15}/>
                                                        Copy
                                                    </button>
                                            ...
                                            <div className="mt-5 flex gap-8 text-sm text-slate-600">
